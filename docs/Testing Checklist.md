...
- [ ] App footer reports Version 3.0.0 Beta 19.
- [ ] Diagnostics reports AccessibleScreenCapture Pro 3.0.0 Beta 19.
- [ ] Installer/package version identifies 3.0.0-19.
...
- [ ] Installer and app identify as 3.0.0 Beta 19 / 3.0.0-19.
...
- [ ] Installer/package identifies as 3.0.0-19.
- [ ] App footer identifies as Version 3.0.0 Beta 19.
...
- [ ] Version is 3.0.0 Beta 19 / package 3.0.0-19.


## Beta 15 - Media synchronization and source protection

- [ ] Application and installer identify as 3.0.0 Beta 19 / 3.0.0-19.
...
- [ ] Debug log contains a recording sync plan with master, video, system-audio, and microphone durations.
- [ ] Saving an edited recording leaves the untouched original recording in Review Queue.
- [ ] Discarding a recording requires confirmation before its pending source file is deleted.
- [ ] Canceling the discard confirmation leaves the recording and its source file untouched.


## Beta 16 - Microphone recording level

- [ ] Installer and application identify as 3.0.0-19 / 3.0.0 Beta 19.
...
- [ ] 125, 150, 175, and 200 percent settings increase microphone level without changing system-audio level.
...
- [ ] Installer/package identifies as 3.0.0-19.
- [ ] Application footer identifies as Version 3.0.0 Beta 19.
...
- [ ] Installer/package identifies as 3.0.0-19 and the app identifies as Version 3.0.0 Beta 19.
...
- [ ] Open Diagnostics, then View Debug Log after stopping the recording.
- [ ] Confirm the log includes `audio balance diagnostic: system pre-mix`.
- [ ] Confirm the log includes microphone `pre-gain` and `post-gain 200 percent` measurements.
- [ ] Confirm the log includes the post-gain microphone/system mean-level difference.
- [ ] Confirm the diagnostic pass does not change, normalize, or otherwise alter the final recording.
